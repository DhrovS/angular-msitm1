...
@NgModule({
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: 'products/2', component: AddHardProductComponent },
      { path: 'Edit/0', component: AddHardProductComponent },
      { path: 'hProd/:id', component: HardDetailsComponent },
  ...
  declarations: [
    ...
    AddHardProductComponent,
    HardDetailsComponent,
